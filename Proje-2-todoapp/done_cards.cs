...
{
    public class done_cards : CardCreator
    {
        public static List<done_cards> Cards = new List<done_cards>();

        public done_cards(string title, string content, TeamMember teamMember) : base(title, content, teamMember, Sizes.S) 
        {
            Cards.Add(this);              
        }
